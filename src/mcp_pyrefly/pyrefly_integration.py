...
class PyreflyChecker:
    ...
    def _parse_output(self, result: subprocess.CompletedProcess, filepath: str) -> Dict[str, Any]:
        ...
        if result.stderr:
            ...
            for line in stderr_lines:
                ...
                if 'error' in line_stripped.lower() and not line_stripped.startswith(('INFO', 'WARNING')):
                    errors.append({
                        "line": 0,
                        "column": 0,
